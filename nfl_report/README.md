...
then extended to generate the same report from raw data for 2018–2026 —
...
│   ├── report_{2018..2026}.csv              # generated by season_report.py
│   ├── results_{2018..2026}.csv             # raw: PFR games + turnovers
│   ├── odds_{2018..2026}.csv                # raw: aussportsbetting odds
...
season with files in `data/`: currently **2018 through 2026**, a fully
...
weeks. This applies to 2019–2026; only **2018**, the earliest season on file,
keeps a blank week 1 (LGT 0, power neutral). Team names are normalised to current nicknames
