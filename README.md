...
|---|---|---|
| [`fantasy_premier_league/`](fantasy_premier_league/) | Seven-factor weekly FPL pick sheet (Quality, Value, Form, Minutes, Nailed, Justice, Crowd vs position peers), backtested on 2025/26, ready for 2026/27; plus a pre-season draft board, a shots/xG/xA board by gameweek, a defcon board for defenders and midfielders, and a team attack/defence board | [open](https://zenoonan.github.io/Research/fantasy_premier_league/) · [pre-season](https://zenoonan.github.io/Research/fantasy_premier_league/preseason.html) · [shots & xG](https://zenoonan.github.io/Research/fantasy_premier_league/shots.html) · [defcon](https://zenoonan.github.io/Research/fantasy_premier_league/defcon.html) · [teams](https://zenoonan.github.io/Research/fantasy_premier_league/teams.html) |
...
| [`premier_league_handicap/`](premier_league_handicap/) | Per-team handicap (bonus points) applied to the Premier League: adjusted table, game-by-game race, cumulative and position grids, the odds market on winning the handicap league, and each club's record against the weekly Asian handicap set beside its pre-season table position. 2026/27 live and updated weekly; 2025/26 complete (web + Streamlit) | [26/27](https://zenoonan.github.io/Research/premier_league_handicap/) · [25/26](https://zenoonan.github.io/Research/premier_league_handicap/2025_2026/) |
