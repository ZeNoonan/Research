...
|---|---|---|
| [`fantasy_premier_league/`](fantasy_premier_league/) | Seven-factor weekly FPL pick sheet (Quality, Value, Form, Minutes, Nailed, Justice, Crowd vs position peers), backtested on 2025/26, ready for 2026/27; plus a pre-season draft board, a shots/xG/xA board by gameweek and a defcon board for defenders and midfielders | [open](https://zenoonan.github.io/Research/fantasy_premier_league/) · [pre-season](https://zenoonan.github.io/Research/fantasy_premier_league/preseason.html) · [shots & xG](https://zenoonan.github.io/Research/fantasy_premier_league/shots.html) · [defcon](https://zenoonan.github.io/Research/fantasy_premier_league/defcon.html) |
